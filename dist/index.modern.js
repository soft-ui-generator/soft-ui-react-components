...
import { hexToRGB, getTintsAndShades } from 'color-processing-library';
...
var ComponentShadows = /*#__PURE__*/function () {
  ...
  _proto.getShadows = function getShadows() {
    var _hexToRGB = hexToRGB(this.backgroundColor),
        Red = _hexToRGB.Red,
    ...
    if (this.sameColorShadow) {
      return mainColorShadows;
        ...
        var _hexToRGB2 = hexToRGB(this.shadowColorBase),
            red = _hexToRGB2.Red,
